...
The BIFs have passed the tests in json_SUITE. A run under valgrind has not
detected any errors or memory leaks.

The BIFs have passed the tests in [[https://github.com/nst/JSONTestSuite][JSONTestSuite]].
